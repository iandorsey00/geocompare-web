...
- Random Google Street View keeps a simple default action, shows inline `Filters`, and exposes only `Arterials` and `Local streets` for optional road-bias targeting.
...
- The app now includes a dedicated GeoCompare favicon and Apple touch icon for browser tabs and saved shortcuts.
